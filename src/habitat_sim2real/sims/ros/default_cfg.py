...
DEFAULT_ROS_CFG.GETTER_TIMEOUT = 1.0
DEFAULT_ROS_CFG.COLOR_IMAGE_TOPIC = "/camera/color/image_raw"
DEFAULT_ROS_CFG.DEPTH_IMAGE_TOPIC = "/camera/aligned_depth_to_color/image_raw"
DEFAULT_ROS_CFG.IMAGE_SYNC_QUEUE_SIZE = 10
DEFAULT_ROS_CFG.MAP_TOPIC = "/map"
DEFAULT_ROS_CFG.MAP_FREE_THRESH = 20
DEFAULT_ROS_CFG.BUMPER_TOPIC = "/mobile_base/kobuki_node/events/bumper"
DEFAULT_ROS_CFG.TF_ROBOT_FRAME = "base_footprint"
DEFAULT_ROS_CFG.TF_REF_FRAME = "map"
DEFAULT_ROS_CFG.TF_HABITAT_ROBOT_FRAME = "habitat_base_footprint"
DEFAULT_ROS_CFG.TF_HABITAT_REF_FRAME = "habitat_map"
DEFAULT_ROS_CFG.TF_TIMEOUT = 1.0
...
DEFAULT_ROS_CFG.DYNAMIXEL_TICK_PER_RAD = 638
DEFAULT_ROS_CFG.DYNAMIXEL_TICK_OFFSET = 2048
DEFAULT_ROS_CFG.DYNAMIXEL_TILT_ID = 9
DEFAULT_ROS_CFG.DYNAMIXEL_TILT_TOL = 16
DEFAULT_ROS_CFG.DYNAMIXEL_TIMEOUT = 5.0
DEFAULT_ROS_CFG.SAMPLE_NAV_PT_METHOD = "MAP" # "RVIZ"
DEFAULT_ROS_CFG.RVIZ_POINT_TOPIC = "/clicked_point"
